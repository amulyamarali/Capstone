...
torch.save(result_rescal.model, '../models/rescal_model.pth')
...
torch.save(result_transe.model, '../models/transe_model.pth')
...
torch.save(result_distmult.model, '../models/distmult_model.pth')
